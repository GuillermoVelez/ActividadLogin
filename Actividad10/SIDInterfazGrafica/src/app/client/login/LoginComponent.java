...
public class LoginComponent extends MouseAdapter implements ActionListener {
    ...
    private String[] placeholder = {"Usuario", "Clave Usuario"};
    private UsuarioService sUsuario; 

    public LoginComponent() {
        sUsuario = UsuarioService.geService();
    ...
    public void enviarDatosUsuario() {
        ...
        if(sUsuario.verificarUsuario(nombreUsuario, claveUsuario)){
            JOptionPane.showMessageDialog(null,"Bienvenid@ a deezer", "Advertencia", 1);
            Entrar();
        }else{
            JOptionPane.showMessageDialog(null,"Tus datos son incorrectos. Vuelve a intentarlo.", "Advertencia", 2);
        }
    }
