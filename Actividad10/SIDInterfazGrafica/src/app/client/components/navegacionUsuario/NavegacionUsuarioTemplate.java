...
public class NavegacionUsuarioTemplate extends JPanel {
    ...
    public void crearJLabels() {
        ...
        //IMAGEN SUSCRIPCION
        iDimAux = new ImageIcon(
                iSuscripcion.getImage().getScaledInstance(180, 150, Image.SCALE_AREA_AVERAGING)
        );
    ...
    public void crearJButtons() {
        ...
        this.bMusica = sObjGraficos.construirJButton(
                ...
                sRecursos.getColorPrincipal(),
                Color.WHITE,
                "l",false,sRecursos.getFontLigera()
        );
        this.bMusica.setIcon(iDimAux);
        this.bMusica.addActionListener(navegacionUsuarioComponent);
        this.bMusica.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bShows.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bExplorar.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bFavoritos.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bMFavoritos.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bPlaylist.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bAlbumes.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bArtistas.addMouseListener(navegacionUsuarioComponent);
        ...
        this.bPodcasts.addMouseListener(navegacionUsuarioComponent);
