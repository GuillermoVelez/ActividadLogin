...
public class ObjetosGraficosService {
    ...
    public JButton construirJButton(String texto, int x, int y, int ancho, int alto, Cursor cursor, Border borde, Color colorFondo, Color colorFuente, String direccion,boolean esSolido, Font fuente) {
