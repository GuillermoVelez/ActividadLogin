...
public class BarraTituloTemplate extends JPanel {
    ...
    public BarraTituloTemplate(BarraTituloComponent barraTituloComponent) {
        ...
        this.setSize(990, 45);
        this.setBackground(sRecursos.getColorPrincipal());
    ...
    public void crearJButtons() {
        ...
        this.bNotificacion.addActionListener(barraTituloComponent);
        ...
        this.bUsuario.addActionListener(barraTituloComponent);
        this.add(bUsuario);
