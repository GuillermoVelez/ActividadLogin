...
public class LoginTemplate extends JFrame {
    ...
    public void crearJButtons() {
        bEntrar= sObjGraficos.construirJButton("Iniciar sesión", (pDerecha.getWidth() - 250) / 2, 370, 250, 45, sRecursos.getcMano(),null, new Color(239, 84, 102), Color.WHITE,"t");
        bEntrar.addActionListener(loginComponent);
        pDerecha.add(bEntrar);
       

        bRegistrarse= sObjGraficos.construirJButton("Registrarse", 255, 15, 115, 30, sRecursos.getcMano(),null, new Color(45, 150, 200), Color.WHITE,"t");
        bRegistrarse.addActionListener(loginComponent);
        pIzquierda.add(bRegistrarse);
      
       
        bApple= sObjGraficos.construirJButton("Apple", 180, 130, 115, 30, sRecursos.getcMano(),null, new Color(25, 25, 34), new Color(255, 255, 255)," ");
        ...
        bFace= sObjGraficos.construirJButton("Facebook", 305, 130, 115, 30, sRecursos.getcMano(), null, new Color(37, 83, 180), new Color(255, 255, 255)," ");
        ...
        bGoogle= sObjGraficos.construirJButton("Google", 180, 170, 115, 30, sRecursos.getcMano(), null, new Color(255, 255, 255), new Color(117, 117, 117)," ");
