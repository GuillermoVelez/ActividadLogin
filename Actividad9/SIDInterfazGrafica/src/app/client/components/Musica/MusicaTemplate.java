...
public class MusicaTemplate extends JPanel{
    ...
    private ImageIcon iCancion1,iCancion2,iCancion3,iCancion4,iPrev,iNext,iDimAux,iDimAux2;
    ...
    public void crearContenidoPSuperior(){
       ...
       bSuperiorPrev=sObjGraficos.construirJButton(null, 900, 2, 15, 15,sRecursos.getcMano(), null, null, null, "", false);
       bSuperiorPrev.addMouseListener(musicaComponent);
       bSuperiorPrev.setIcon(iDimAux);    
       pSuperior.add(bSuperiorPrev);
       bSuperiorNext=sObjGraficos.construirJButton(null, 925, 2, 15, 15,sRecursos.getcMano(), null, null, null, "", false);
       bSuperiorNext.addMouseListener(musicaComponent);
    ...
    public void crearContenidoPinferior(){
       bInferiorPrev=sObjGraficos.construirJButton(null, 900, 2, 15, 15,sRecursos.getcMano(), null, null, null, "", false);
       bInferiorPrev.addMouseListener(musicaComponent);
       bInferiorNext=sObjGraficos.construirJButton(null, 925, 2, 15, 15,sRecursos.getcMano(), null, null, null, "", false);
       bInferiorNext.addMouseListener(musicaComponent);
