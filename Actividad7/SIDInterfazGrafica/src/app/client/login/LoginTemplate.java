...
public class LoginTemplate extends JFrame {
    ...
    public void crearJButtons() {
        bEntrar= sObjGraficos.construirJButton("Iniciar sesión", (pDerecha.getWidth() - 250) / 2, 370, 250, 45, sRecursos.getcMano(),null, new Color(239, 84, 102), Color.WHITE,"t",true);
        bEntrar.addActionListener(loginComponent);
        pDerecha.add(bEntrar);
       

        bRegistrarse= sObjGraficos.construirJButton("Registrarse", 255, 15, 115, 30, sRecursos.getcMano(),null, new Color(45, 150, 200), Color.WHITE,"t",true);
        bRegistrarse.addActionListener(loginComponent);
        pIzquierda.add(bRegistrarse);
      
       
        bApple= sObjGraficos.construirJButton("Apple", 180, 130, 115, 30, sRecursos.getcMano(),null, new Color(25, 25, 34), new Color(255, 255, 255)," ",true);
        ...
        bFace= sObjGraficos.construirJButton("Facebook", 305, 130, 115, 30, sRecursos.getcMano(), null, new Color(37, 83, 180), new Color(255, 255, 255)," ",true);
